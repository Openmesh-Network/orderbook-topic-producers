...
class Orderbook(ABC):
    ...
    @abstractmethod
    def book_top() -> dict:
        """Returns the top of the orderbook, the best bid and ask and their sizes.
        ...
        -------
        dict
            A dictionary containing the best bid and ask prices, along with the
            sizes at the price level.
        """